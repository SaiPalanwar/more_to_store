			...
			<div class="col-sm-5">
				...
				<div class="row">
					<c:forEach items="${mobile.images}" var="image">
						<div class="col-lg-3">
							<img style="border: 2px solid; padding: 10px"
								src="data:image/jpeg;base64,${image.imgUtility}"
							...
							<div class="col-sm-12">
								...
								<div class="panel panel-default" id="specifications">
									<div class="panel-heading" style="background-color: #fff;">
										<h3 style="color: black;">Technical Details</h3>
									</div>
									...
									<div class="panel-body">
											...
											Lightning to USB Cable, USB Power Adapter, Documentation</td>
												...
												<tr>
													...
													<td class="col-sm-8"><span
														style="background-color:${mobile.technicalDetails.color};">__________</span>
													</td>
												</tr>
												<tr>
										...
										<div class="row">
											...
											<table class="table bg-dark">
												<tr>
													<th><h2>Manufacture Details</h2></th>
												<tr>
												<tr>
													<th></th>
													<th></th>
												...
												<tr>
													...
													<td>${mobile.manufactureInformation.manufactureInfo}</td>
												</tr>
												<tr>
													<td>Manufacture Date:</td>
													<td>${mobile.manufactureInformation.manufactureDate}</td>
												</tr>
												<tr>
													<td>Manufacture Address:</td>
													<td>${mobile.manufactureInformation.manufactureLocation}</td>
												</tr>
											</table>
