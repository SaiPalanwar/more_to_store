			...
			<div class="col-md-3 text-center">
				<ul class="list-unstyled mb-0">
					<li><i class="fas fa-map-marker-alt fa-2x"></i>
						<p>Innovation Park 34, B/1, Panchawati Rd, Panchawati, Pashan,
							Pune, Maharashtra 411008</p></li>

					<li><i class="fas fa-phone"></i>
						<p>+91 8767855143</p></li>

					<li><i class="fas fa-envelope"></i>
						<p>infomoretostore@gmail.com</p></li>
				</ul>
			</div>
			<hr>
			...
			<div class="col">
				<div class="gmap_canvas">
					<iframe width="100%" height="300px" id="gmap_canvas"
						src="https://maps.google.com/maps?q=shri%20ram%20book%20agency%20pune&t=&z=13&ie=UTF8&iwloc=&output=embed"
